            ...
            <table class="table table-index w-full">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.wallet.fields.real_money') }}
                            @include('components.table.sort', ['field' => 'real_money'])
                        </th>
                        <th>
                            {{ trans('cruds.wallet.fields.virtual_money') }}
                            @include('components.table.sort', ['field' => 'virtual_money'])
                        </th>
                        <th>
                        </th>
                    </tr>
                ...
                <tbody>
                    @forelse($wallets as $wallet)
                        <tr>
                            ...
                            <td>
                                @if($wallet->user)
                                    <span class="badge badge-relationship">{{ $wallet->user->email ?? '' }}</span>
                                @endif
                            </td>
                            <td>
                                {{ $wallet->real_money }}
